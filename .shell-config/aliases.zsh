...
alias refresh_db="pg_restore --verbose --disable-triggers --host localhost --username `whoami` --data-only --no-owner --no-acl --jobs=10 --dbname "
alias itcrashed="rm /usr/local/var/postgresql/postmaster.pid;brew services restart postgresql"
